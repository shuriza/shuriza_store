      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
            ...
            <li>
              <a href="{{ url('/about') }}" class="block py-2 px-3 md:p-0 text-white bg-green-500 rounded md:hover:bg-transparent md:bg-transparent md:text-green-500 md:border-0 md:hover:text-green-500"> About </a>
            </li>
            <li>
              <a href="{{ url('/contact') }}" class="block py-2 px-3 md:p-0 rounded md:bg-transparent md:text-white md:hover:text-green-500 hover:bg-gray-100 md:hover:bg-transparent"> Contact </a>
            </li>
            <li>
